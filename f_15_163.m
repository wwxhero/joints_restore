...
f_15_163_names = {
			'root=>root',...
			'upperleg01.L=>upperleg01.L',...
			'upperleg01.L=>pelvis.L',...
			'lowerleg01.L=>lowerleg01.L',...
			'lowerleg01.L=>upperleg02.L',...
			'foot.L=>foot.L',...
			'foot.L=>lowerleg02.L',...
			'upperleg01.R=>upperleg01.R',...
			'upperleg01.R=>pelvis.R',...
			'lowerleg01.R=>lowerleg01.R',...
			'lowerleg01.R=>upperleg02.R',...
			'foot.R=>foot.R',...
			'foot.R=>lowerleg02.R',...
			'spine03=>spine03',...
			'spine03=>spine04',...
			'spine03=>spine05',...
			'upperarm01.L=>upperarm01.L',...
			'upperarm01.L=>shoulder01.L',...
			'upperarm01.L=>clavicle.L',...
			'upperarm01.L=>spine01',...
			'upperarm01.L=>spine02',...
			'lowerarm01.L=>lowerarm01.L',...
			'lowerarm01.L=>upperarm02.L',...
			'wrist.L=>wrist.L',...
			'wrist.L=>lowerarm02.L',...
			'upperarm01.R=>upperarm01.R',...
			'upperarm01.R=>shoulder01.R',...
			'upperarm01.R=>clavicle.R',...
			'upperarm01.R=>spine01',...
			'upperarm01.R=>spine02',...
			'lowerarm01.R=>lowerarm01.R',...
			'lowerarm01.R=>upperarm02.R',...
			'wrist.R=>wrist.R',...
...
f_15_163_t(1:n_parm) = 0;
for i_param = 1:n_parm
	i_15 = f_15_163_params(i_param, 1);
	i_173 = f_15_163_params(i_param, 2);
	[J_173_prime(:, i_173), f_15_163_t(i_param)] = f_i_inv(J_15(:, i_15), J_173(:, i_173), t);
end
J_173_prime_t = J_173_prime';

fid = fopen('param_t.csv', 'wt');
for i_g = 1:n_parm
		name = f_15_163_names{i_g};
		inter_t = f_15_163_t(i_g);
		fprintf(fid, '\n%s, %.4f', name, inter_t);
end
fclose(fid);
